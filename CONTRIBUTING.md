# Contributing to Search Service
...
```bash
git clone https://github.com/YOUR_USERNAME/search_service.git
cd search_service
```
...
```bash
git remote add upstream https://github.com/mission-engadi/search_service.git
```
